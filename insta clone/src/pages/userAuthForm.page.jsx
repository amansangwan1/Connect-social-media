  ...
  return accessToken ? (
    ...
    <AnimationWrapper keyValue={type}>
      <section className=" h-screen w-screen flex justify-center self-center bg-black text-white">
        <Toaster></Toaster>
        <form
          className="w-[80%] max-w-[400px] my-auto border-dark-grey border px-4 py-4"
          id="authForm"
        >
          ...
          <button
            className="btn-light center mt-14 w-full"
            type="submit"
          ...
          <button
            className="btn-light flex items-center justify-center gap-4 center w-full"
